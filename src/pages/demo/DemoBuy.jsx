                ...
                {orders.map(order => (
                  <tr key={order._id}>
                    ...
                    <td className=\"px-6 py-4 whitespace-nowrap\">
                      <span className={px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full src\utils{order.PaymentStatus === 'Confirmed' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'}}>
                        {order.PaymentStatus}
                      </span>
                    </td>
